...
sind eine Gruppe Studenten, die sich für die Interessen der Studentenschaft einsetzen. Zu unserer Arbeit
gehört einerseits die studentische Vertretung in den Universitätsgremien, andererseits versuchen wir, unseren
Studenten das Leben an der Universität zu erleichtern (z. B. durch Ersti-Betreuung, Feste, Beratung etc.).
Dabei arbeiten wir eng mit der Fachschaft Informatik (fsi) zusammen.
\else
\glqq Fachschaft\grqq, wer oder was ist das eigentlich? Wir, die Fachschaft Informatik, sind eine Gruppe Studenten aus den Fächern
Informatik, Bioinformatik, Medieninformatik, Medizininformatik und Machine Learning, die sich für die Interessen der Studentenschaft einsetzen. Zu unserer Arbeit
gehört einerseits die studentische Vertretung in den Universitätsgremien, andererseits versuchen wir, unseren
Kommilitonen das Leben an der Universität zu erleichtern (z. B. durch Ersti-Betreuung, Feste, Beratung etc.).
...
Bei den Veranstaltungen werden viele Studenten aus höheren Semestern anwesend sein, die dir gerne alle Fragen beantworten.
So kannst du dir einen groben Überblick über dein Studium in Tübingen verschaffen und dabei schon die ersten Kontakte zu deinen Kommilitonen knüpfen.
...
\par\hfill
{\footnotesize Redaktion: David und Sebastian - und alle, die vorher dagewesen sind}
\fi
\vfill
