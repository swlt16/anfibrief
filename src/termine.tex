...
\fcolorbox{red}{white}{
  \begin{minipage}[t]{\textwidth}
    ...
    \else
      ...
      \noindent
      \begin{minipage}[t]{\dimexpr\linewidth-43mm\relax}
        \vspace{0pt}
      ...
      \begin{minipage}[t]{38mm}
        \vspace{0pt}
        \centering
        \qrcode[height=29mm]{https://eei.fsi.uni-tuebingen.de/}
      \end{minipage}
    \fi
  \end{minipage}
}
...
% Hinweis für Bussituation im WiSe26, ein TODO zum entfernen
\vspace{2cm}
\fcolorbox{blue}{white}{
  \begin{minipage}[t]{\textwidth}
    \textbf{Wichtiger Hinweis zur Buslinie 6 Richtung Sand}\\
    Beim Verfassen dieses Briefs fährt die Linie 6 die Haltestelle \textit{Sand Drosselweg} aufgrund einer Baustelle im Fichtenweg nicht an.
    Die Stadtwerke nennen aktuell den 31. Oktober 2026 als Enddatum der Bauarbeiten, die Wegbeschreibungen können sich also im Laufe des Ersti-Programms noch ändern. \\

    Quelle: \url{https://www.tuebus.de/fahrgastinformationen/verkehrsmeldungen/detail/sperrung-falkenweg.html}
  \end{minipage}
}
