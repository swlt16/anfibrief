...
% Der erste Eintrag in 'date' wird als Sortierschlüssel genutzt.
...
% Stadtrallye
\DeclareTermin{
  date = {2026-10-13 16:30:00},
  icon = {faFlag},
  title-de = {Stadtrallye}, title-en = {City Rallye},
  date-de = {Dienstag, den 13. Oktober \YEAR}, date-en = {Tuesday, October 13th \YEAR},
  time-de = {16:30 Uhr}, time-en = {16:30},
  location-de = {Verschiedene Orte}, location-en = {Various locations},
  body-de = {
    Wir lassen dich und deine Kommilitonen gegeneinander in Teams antreten. Dabei werdet ihr interessante, schöne und verstörende Ecken Tübingens kennenlernen, dabei hoffentlich die Orientierung in eurer neuen Heimat etwas verbessern und Kontakte knüpfen. Melde dich mit deinen Daten an, um genaue Informationen zu Treffpunkt und deiner Gruppe zu bekommen.
  },
  body-en = {
    We'll have you and your fellow students compete against each other in teams. You will get to know interesting, beautiful and disturbing corners of Tübingen, hopefully improve your orientation in your new home and make new contacts. Sign up with your details to get exact information about the meeting point and your group.
  }
}
  ...
  \else
    \DeclareTermin{
      ...
      body-de = {
        ...
        und schau ob es dir gefällt!\\
        Bitte auch hier über's EEI anmelden - es gibt Essen!\\
        \seticon{faBus}~\textbf{Bushaltestelle:} Sand Drosselweg (Linien 2 \& 6)
      }
    }
  \fi
