...
% 'date' wird als Sortierschlüssel genutzt, die Reihenfolge in diesem File ist also völlig egal. 
...
% Facheinfuehrung
\DeclareTermin{
  % Sortierwert; der tatsaechliche Termin ist studiengangsabhaengig.
