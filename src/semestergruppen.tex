...
\else
    ...
    \ifml
        ...
        \begin{center}
            % ML immer Master
            % TODO QR-Codes und Links austauschen!
            \includegraphics[width=45mm, keepaspectratio=true]{media/qrcode-signal-master.png} \\
            {
                \footnotesize
                \url{https://signal.group/#CjQKIFU_UY-EbSNNTeC0jUDBYAi2b2ZpU0_CFWYxo4KtET9VEhB04WXy9gsxr-TiGa1xJLbi}
            }
        \end{center}
    ...
    \else
        ...
        \begin{center}
            ...
            \else
                % Bachelor
                % TODO QR-Codes und Links austauschen!
                \includegraphics[width=45mm, keepaspectratio=true]{media/qrcode-signal-bachelor.png} \\
                {
                    \footnotesize
                    \url{https://signal.group/#CjQKIBLZvMV75ifvTGG_lyhAHPVtlq3CTLZ6DYeLSuBirhL5EhD59M8ZZaM-7_r_7EI_ym9Q}
                }
            \fi
        \end{center}
